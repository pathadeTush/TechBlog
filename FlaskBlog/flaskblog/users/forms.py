...
# RegistrationForm class represents the registration form structure. Using FlaskForm we can write form easily in python using OOP. While running this form gets converted to html forms
